...
<html>
  <title>Add Donor to Database</title>
  ...
  echo '<div class="alert alert-danger">Incorrect submission or duplicate Donor ID!:';
            ...
            <fieldset>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  ...
                  <p class="help-block">Provide username to Facebook account. http://facebook.com/<b>thisisusername</b>/</p>
                </div>
              </div>
              <div class="control-group">
                <!-- FBID -->
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" id="ref" name="ref" placeholder="<?php echo $_SESSION['username']; ?>" class="input-xxlarge" disabled>
                </div>
              </div>

        ...
        <div class="col-md-12">
          <div class="panel panel-primary">
            <div class="panel-heading">
              ...
              <span class="glyphicon glyphicon-bookmark"></span> Main Menu <span class="glyphicon glyphicon-bookmark"></span></h3>
            </div>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="approve.php?isGood=0&id=<?php echo $row["id"]; ?>" class="btn btn-danger" role="button">Delete</a>
                  </td>
                </tr>
                <?php
